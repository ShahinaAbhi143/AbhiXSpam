...
from AbhiExtra.start import start_cmd
...
async def _start(AbhiXSpam: Client, message: Message):
    global START_MESSAGE
    my_detail = await AbhiXSpam.get_me()
        ...
        for i in range(1, 26):
            ...
            if lol is not None:
                await lol.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(await start_cmd(AbhiXSpam)),
                )
