...
from AbhiExtra.porn import pornlinks
...
async def spam(AbhiXSpam: Client, e: Message):
...
async def delayspam(AbhiXSpam: Client, e: Message):
...
async def _pornspam(AbhiXSpam: Client, e: Message):
...
async def _hangchat(AbhiXSpam: Client, e: Message):
