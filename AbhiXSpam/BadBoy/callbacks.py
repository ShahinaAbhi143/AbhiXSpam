...
from AbhiXSpam.cmd_help import *


@Client.on_callback_query()
async def _callbacks(AbhiXSpam: Client, callback_query: CallbackQuery):
    user = await AbhiXSpam.get_me()
    user.mention
    ...
    if query.startswith("helpmenu1"):
        if query == "helpmenu1":
            ...
            await AbhiXSpam.edit_message_text(
                chat_id=chat_id,
                message_id=message_id,
                text="🚬 ʜᴇʟᴘ ᴍᴇɴᴜ 🚬\n\n   Powered By @ceo_of_secularism",
    ...
    # For Future Use
        ...
        await AbhiXSpam.edit_message_text(
            chat_id=chat_id,
            message_id=message_id,
            text="ʜᴇʟᴘ ᴍᴇɴᴜ ᴘᴏᴡᴇʀᴇᴅ ʙʏ  @imagine_iq",
            disable_web_page_preview=True,
